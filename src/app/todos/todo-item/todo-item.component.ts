...
export class TodoItemComponent implements OnInit {
  ...
  chkCompleted: UntypedFormControl;
  txtInput: UntypedFormControl;
  isEditing = false;
  ...
  ngOnInit(): void {
    this.chkCompleted = new UntypedFormControl(this.todo.completed);
    this.txtInput = new UntypedFormControl(this.todo.text, Validators.required);
